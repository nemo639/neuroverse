...
// Add these:
  ...
  final List<TestComponent> testComponents = [
    ...
    TestComponent(
      ...
      description: 'Hold vowel sounds for analysis',
      duration: '2 min',
      isCompleted: false,
    ...
    TestComponent(
      ...
      description: 'Describe images verbally',
      duration: '4 min',
      isCompleted: false,
...
void _showCompleteDialog() {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Voice-based analysis to detect speech patterns, pauses, and language comprehension that may indicate cognitive decline.',
                      style: TextStyle(
                        fontSize: 13,
                        fontWeight: FontWeight.w500,
  ...
  Widget _buildBeforeYouStartCard() {
    final tips = [
      ...
      'Complete all tests in one session for accurate results',
    ];
              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    ...
                    color: test.isCompleted ? greenAccent : blueAccent,
                    size: 24,
                  ),
                ),
                const SizedBox(width: 14),
